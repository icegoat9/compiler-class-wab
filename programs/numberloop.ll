...
define i32 @mergeloop(i32 %.arg_n) {
entry:
    %n = alloca i32
    store i32 %.arg_n, i32* %n
    br label %L39
...
L35:
    ...
    br i1 %.r78, label %L19, label %L25
L19:
    %.r79 = load i32, i32* %n
    call i32 (i32) @_print_int(i32 %.r79)
    %.r80 = load i32, i32* %n
    store i32 %.r80, i32* %prev
    %.r81 = load i32, i32* %n
    %.r82 = call i32 (i32) @mergedigits(i32 %.r81)
    store i32 %.r82, i32* %n
    %.r83 = load i32, i32* %loops
    %.r84 = add i32 %.r83, 1
    store i32 %.r84, i32* %loops
    br label %L36
L36:
    %.r85 = load i32, i32* %prev
    %.r86 = load i32, i32* %n
    %.r87 = icmp eq i32 %.r85, %.r86
    br i1 %.r87, label %L20, label %L21
L20:
...
L21:
    %len = alloca i32
    %.r88 = load i32, i32* %n
    %.r89 = call i32 (i32) @lennum(i32 %.r88)
    store i32 %.r89, i32* %len
    br label %L37
L37:
    %.r90 = load i32, i32* %len
    %.r91 = icmp sge i32 %.r90, 8
    br i1 %.r91, label %L22, label %L38
L22:
    store i32 2, i32* %endloop
    br label %L35
L38:
    %.r92 = load i32, i32* %loops
    %.r93 = icmp sgt i32 %.r92, 20
    br i1 %.r93, label %L23, label %L24
L23:
...
L24:
    ...
    br label %L35
L25:
    %.r94 = load i32, i32* %endloop
    ret i32 %.r94
}
@runtests = global i32 0

define i32 @main() {
entry:
    br label %L26
L26:
    store i32 0, i32* @runtests
    br label %L40
L40:
    %.r95 = load i32, i32* @runtests
    %.r96 = icmp ne i32 %.r95, 0
    br i1 %.r96, label %L27, label %L28
L27:
    %.r97 = call i32 (i32, i32) @pow(i32 2, i32 5)
    call i32 (i32) @_print_int(i32 %.r97)
    %.r98 = call i32 (i32, i32) @pow(i32 3, i32 1)
    call i32 (i32) @_print_int(i32 %.r98)
    %.r99 = call i32 (i32, i32) @mod(i32 13, i32 3)
    call i32 (i32) @_print_int(i32 %.r99)
    %.r100 = call i32 (i32, i32) @concat(i32 12, i32 345)
    call i32 (i32) @_print_int(i32 %.r100)
    %.r101 = call i32 (i32) @lennum(i32 9)
    call i32 (i32) @_print_int(i32 %.r101)
    %.r102 = call i32 (i32) @lennum(i32 10)
    call i32 (i32) @_print_int(i32 %.r102)
    %xa = alloca i32
    store i32 123456, i32* %xa
    call i32 (i32) @_print_int(i32 123456)
    %.r103 = load i32, i32* %xa
    %.r104 = call i32 (i32) @lennum(i32 %.r103)
    call i32 (i32) @_print_int(i32 %.r104)
    %.r105 = load i32, i32* %xa
    %.r106 = call i32 (i32, i32) @digitn(i32 %.r105, i32 1)
    call i32 (i32) @_print_int(i32 %.r106)
    %.r107 = load i32, i32* %xa
    %.r108 = call i32 (i32, i32) @digitn(i32 %.r107, i32 5)
    call i32 (i32) @_print_int(i32 %.r108)
    %x = alloca i32
    store i32 4396, i32* %x
    %.r109 = load i32, i32* %x
    call i32 (i32) @_print_int(i32 %.r109)
    %.r110 = load i32, i32* %x
    %.r111 = call i32 (i32) @mergedigits(i32 %.r110)
    call i32 (i32) @_print_int(i32 %.r111)
    %.r112 = call i32 (i32) @mergedigits(i32 7)
    call i32 (i32) @_print_int(i32 %.r112)
    br label %L29
L28:
    %.r113 = call i32 (i32) @mergeloop(i32 1467)
    call i32 (i32) @_print_int(i32 %.r113)
    %.r114 = call i32 (i32) @mergeloop(i32 1792)
    call i32 (i32) @_print_int(i32 %.r114)
    %.r115 = call i32 (i32) @mergeloop(i32 1537)
    call i32 (i32) @_print_int(i32 %.r115)
    br label %L29
L29:
    ret i32 0
}
