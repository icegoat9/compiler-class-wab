...
; original unedited code, just function renamed
define i32 @exercise1_original(i32 %x)
{
    %r1 = mul i32 %x, 2
    ret i32 %r1
}
...
; original unedited code, just function renamed
define i32 @exercise2_original(i32 %x)
{
    %result = alloca i32
...
L1:
    store i32 0, i32* %result        ; result = 0
    br label %L5                     

L2:
    %r3 = icmp sgt i32 %x, 5         ; if x > 5
    br i1 %r3, label %L3, label %L4  ; branch depending on result
...
L5:
    %r4 = load i32, i32* %result     ; return result
    ret i32 %r4
}
...
; original unedited code, just function renamed
define void @exercise3_original(i32 %x)
{
...
{
    %n = alloca i32             ; allocate address n as global loop counter (to persist across labels / branches)
    store i32 %x, i32* %n       ; starting value for n = x
    br label %L1

L1: 
    %r1 = load i32, i32* %n            ; r1 = n
    %r2 = icmp slt i32 %r1, 10         ; r1 < 10 ?
    br i1 %r2, label %L2, label %L3    ; branch depending on result of comparison

L2:
    %r3 = load i32, i32* %n            ; r3 = n (holds value locally for manipulation)
    call void (i32) @printi(i32 %r3)   ; print(r3)
    %r4 = add i32 %r3, 1               ; r4 = r3 + 1
    store i32 %r4, i32* %n             ; store r4 back to n (i.e. n+=1)
    br label %L1                       ; loop
